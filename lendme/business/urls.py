...
urlpatterns = [
    ...
    path("offer/accept/<int:pk>", views.OfferAcceptApiView.as_view(), name="offeraccept"),
    path("offer/schedpayment/<int:pk>", views.ScheduledPaymentRetrieveAPIView.as_view(), name="offerschedpayment"),
    path("payment/pay/<int:pk>", views.payInstallmentApiView.as_view(), name="payschedpayment"),
]
